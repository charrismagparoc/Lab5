              ...
              <div>
                <div className="form-2">
                  <div className="form-grp">
                    ...
                    <select className="form-ctrl" value={form.type} onChange={e => setForm({...form, type:e.target.value})}>
                  ...
                  <div className="form-grp full">
                    ...
                    <input className="form-ctrl" placeholder="e.g. Near Cagayan River, Purok 2..." value={form.location} onChange={e => setForm({...form, location:e.target.value})} />
                  </div>
                  <div className="form-grp">
                    <label>Severity</label>
                    <select className="form-ctrl" value={form.severity} onChange={e => setForm({...form, severity:e.target.value})}>
                      <option>Low</option><option>Medium</option><option>High</option>
                    </select>
                  </div>
                  <div className="form-grp">
                    <label>Reported By *</label>
                    <input className="form-ctrl" placeholder="Full name..." value={form.reporter} onChange={e => setForm({...form, reporter:e.target.value})} />
                  </div>
                  <div className="form-grp full">
                    <label>Description</label>
                    <textarea className="form-ctrl" rows={3} placeholder="Describe the situation..." value={form.description||''} onChange={e => setForm({...form, description:e.target.value})}></textarea>
                  </div>
                </div>
